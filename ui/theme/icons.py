"""
Icon System - Ícones SVG inline baseados no Lucide Icons.
Sistema de ícones leve, sem dependências externas.
"""
...
# ============================================================
# SVG Paths - Lucide Icons (16x16 viewBox, strokeWidth 2)
# ============================================================
ICONS: dict[str, str] = {
    # Navigation
    "sidebar": '<path d="M18 3a3 3 0 0 0-3 3v12a3 3 0 0 0 3 3 3 3 0 0 0 3-3 3 3 0 0 0-3-3H6a3 3 0 0 0-3 3 3 3 0 0 0 3 3 3 3 0 0 0 3-3V6a3 3 0 0 0-3-3 3 3 0 0 0-3 3 3 3 0 0 0 3 3h12a3 3 0 0 0 3-3 3 3 0 0 0-3-3z"/>',
    "panel-left": '<rect width="18" height="18" x="3" y="3" rx="2" ry="2"/><line x1="9" x2="9" y1="3" y2="21"/>',
    "panel-right": '<rect width="18" height="18" x="3" y="3" rx="2" ry="2"/><line x1="15" x2="15" y1="3" y2="21"/>',
    # Actions
    ...
    "file-image": '<rect width="18" height="18" x="3" y="3" rx="2" ry="2"/><circle cx="9" cy="9" r="2"/><path d="m21 15-3.086-3.086a2 2 0 0 0-2.828 0L6 21"/>',
    "file-audio": '<path d="M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7Z"/><path d="M14 2v4a2 2 0 0 0 2 2h4"/><path d="M10 12v6"/><path d="M14 12v6"/><path d="M8 12v6"/>',
    ...
    "loader-3": '<circle cx="12" cy="12" r="8"/><path d="M12 2v4"/><path d="m16.2 7.8 2.9-2.9"/><path d="M18 12h4"/><path d="m16.2 16.2 2.9 2.9"/><path d="M12 18v4"/><path d="m4.9 19.1 2.9-2.9"/><path d="M2 12h4"/><path d="m4.9 4.9 2.9 2.9"/>',
    # Arrows
    ...
    # Inventory / Kanban
    "package": '<line x1="16.5" x2="7.5" y1="2.5" y2="2.5"/><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"/><polyline points="3.27 6.96 12 12.01 20.73 6.96"/><line x1="12" x2="12" y1="22.08" y2="12"/>',
    "package-plus": '<path d="M16 16h6"/><path d="M19 13v6"/><path d="M21 11V9a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v14c0 1.1.9 2 2 2h5"/><path d="M12 3v6a2 2 0 0 0 2 2h4"/><path d="m3 3 1.9 5.7a8.5 8.5 0 0 0 3.8 3.8"/><path d="m21 21-1.9-5.7a8.5 8.5 0 0 0-3.8-3.8"/>',
    "package-check": '<path d="m16 16 2 2 4-4"/><path d="M21 10V8a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v14c0 1.1.9 2 2 2h5"/><path d="M12 3v6a2 2 0 0 0 2 2h4"/><path d="M3 3 1.9 5.7a8.5 8.5 0 0 0 3.8 3.8"/>',
    "package-x": '<path d="m21 8-2-2-5 5"/><path d="M21 14v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h6"/><path d="M12 3v6a2 2 0 0 0 2 2h4"/><path d="m3 3 1.9 5.7a8.5 8.5 0 0 0 3.8 3.8"/><path d="m9.7 16.7 2.3-2.3"/>',
    ...
    "scan-barcode": '<path d="M3 7V5a2 2 0 0 1 2-2h2"/><path d="M17 3h2a2 2 0 0 1 2 2v2"/><path d="M21 17v2a2 2 0 0 1-2 2h-2"/><path d="M7 21H5a2 2 0 0 1-2-2v-2"/><line x1="7" x2="7" y1="12" y2="12"/><line x1="10" x2="10" y1="12" y2="12"/><line x1="13" x2="13" y1="12" y2="12"/><line x1="16" x2="16" y1="12" y2="12"/>',
    # Misc
    ...
    "square-check": '<rect width="18" height="18" x="3" y="3" rx="2" ry="2"/><path d="m9 12 2 2 4-4"/>',
    ...
    "alert-octagon": '<path d="M7.86 2h8.28L21.14 7.86 12 21.14 2.86 7.86 7.86 2z"/><path d="M12 8v4"/><path d="M12 16h.01"/>',
    ...
    "timer": '<line x1="10" x2="14" y1="2" y2="2"/><path d="M12 2a10 10 0 1 0 10 10 4 4 0 0 1-5-5 4 4 0 0 1-5-5"/>',
    "stopwatch": '<circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/>',
    "hourglass": '<path d="M5 22h14"/><path d="M5 2h14"/><path d="M17 22v-4.172a2 2 0 0 0-.586-1.414L12 12l-4.414 4.414A2 2 0 0 0 7 17.828V22"/><path d="M7 2v4.172a2 2 0 0 0 .586 1.414L12 12l4.414-4.414A2 2 0 0 0 17 6.172V2"/>',
    "at-sign": '<circle cx="12" cy="12" r="4"/><path d="M16 8v5a3 3 0 0 0 6 0v-1a10 10 0 1 0-4 8"/>',
}


def create_icon(name: str, color: str = None, size: int = 24) -> QIcon:
    """Cria um QIcon a partir do nome e cor.

    Args:
        name: Nome do ícone (chave do dicionário ICONS)
        color: Cor em hex (ex: "#1A1A1B") ou None para preto
        size: Tamanho em pixels

    Returns:
        QIcon com o ícone renderizado
    """
...
def icon(name: str, color: str = None, size: int = 24) -> QIcon:
    """Atalho para create_icon."""
    return create_icon(name, color, size)


def list_icons() -> list[str]:
    """Retorna lista de todos os nomes de ícones disponíveis."""
